...
![1](C:\WorkSpace\lazycat\0-python基础\image\1.png)
...
目前Python在Web服务器开发、云开发、**网络数据采集**、**数据分析**、量化交易、**机器学习**、**深度学习**、自动化测试、自动化运维等领域都有用武之地。
...
![](C:\WorkSpace\lazycat\0-python基础\100\Day01-15\res\python-idle.png)
...
![](C:\WorkSpace\lazycat\0-python基础\100\Day01-15\res\python-ipython.png)

#### Sublime Text - 高级文本编辑器

![](C:\WorkSpace\lazycat\0-python基础\100\Day01-15\res\python-sublime.png)
...
![](C:\WorkSpace\lazycat\0-python基础\100\Day01-15\res\python-pycharm.png)
